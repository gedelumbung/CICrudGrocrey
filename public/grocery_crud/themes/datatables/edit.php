<?php 
	...
	$this->load->js('public/grocery_crud/themes/datatables/js/datatables-edit.js');
...
<div class='form-content form-div'>
	<form action='<?=$update_url?>' method='post' id='crudForm' autocomplete='off' enctype="multipart/form-data">
		<div>
		<?php
			$counter = 0; 
